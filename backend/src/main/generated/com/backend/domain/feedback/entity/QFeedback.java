...
public class QFeedback extends EntityPathBase<Feedback> {
    ...
    private static final long serialVersionUID = 188020746L;
    ...
    public final com.backend.domain.answer.entity.QAnswer answer;
    ...
    public QFeedback(Class<? extends Feedback> type, PathMetadata metadata, PathInits inits) {
        ...
        this.answer = inits.isInitialized("answer") ? new com.backend.domain.answer.entity.QAnswer(forProperty("answer"), inits.get("answer")) : null;
    }

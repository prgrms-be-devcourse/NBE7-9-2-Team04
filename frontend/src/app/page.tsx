...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    const loggedIn = typeof localStorage !== 'undefined' ? localStorage.getItem("isLoggedIn") === "true" : false;
    ...
    <div className="min-h-screen bg-white text-gray-900">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="rounded-lg border border-gray-200 shadow-sm flex flex-col bg-white">
              <div className="p-6 space-y-2">
                <span className="w-10 h-10 mb-2 text-blue-600 text-3xl">👥</span>
                <h3 className="text-xl font-semibold">팀 프로젝트 & 스터디 모집</h3>
                <p className="text-sm text-gray-600">함께 성장할 팀원을 찾고 스터디 그룹을 만들어보세요</p>
              </div>
              <div className="p-6 pt-0 flex-grow">
                <Link href="/recruitment" className="text-blue-500 hover:underline p-0">
                  모집글 보기
                </Link>
              </div>
            </div>
            ...
            <div className="rounded-lg border border-gray-200 shadow-sm flex flex-col bg-white">
              <div className="p-6 space-y-2">
                ...
                <p className="text-sm text-gray-600">네트워크, 운영체제 등 CS 지식을 문제로 학습하세요</p>
              </div>
              <div className="p-6 pt-0 flex-grow">
                <Link href="/interview/cs" className="text-blue-500 hover:underline p-0">
                  문제 풀기
                </Link>
              </div>
            </div>
            ...
            <div className="rounded-lg border border-gray-200 shadow-sm flex flex-col bg-white">
              <div className="p-6 space-y-2">
                <span className="w-10 h-10 mb-2 text-blue-500 text-3xl">📖</span>
                <h3 className="text-xl font-semibold">포트폴리오 면접 준비</h3>
                <p className="text-sm text-gray-600">AI가 당신의 포트폴리오를 분석하고 예상 질문을 제공합니다</p>
              </div>
              <div className="p-6 pt-0 flex-grow">
            ...
            <div className="rounded-lg border border-gray-200 shadow-sm flex flex-col bg-white">
              ...
              <div className="p-6 pt-0 flex-grow">
                <Link href="/ranking" className="text-blue-500 hover:underline p-0">
                  랭킹 보기
                </Link>
              </div>
            </div>
            ...
            <div className="rounded-lg border border-gray-200 shadow-sm flex flex-col bg-white">
              <div className="p-6 space-y-2">
                ...
                <p className="text-sm text-gray-600">궁금한 점을 질문하고 다른 개발자들과 소통하세요</p>
              </div>
              <div className="p-6 pt-0 flex-grow">
                <Link href="/qna" className="text-blue-500 hover:underline p-0">
                  질문하기
                </Link>
              </div>
            </div>
            ...
            <div className="rounded-lg border border-blue-300 shadow-sm flex flex-col bg-blue-50"> 
              <div className="p-6 space-y-2">
                ...
                <p className="text-sm text-gray-600">상단 광고 노출과 더 많은 혜택을 누려보세요</p>
              </div>
              <div className="p-6 pt-0 flex-grow">
                <button 
      ...
      <section className="py-20 px-4"> 
        <div className="mx-auto max-w-4xl text-center space-y-6">
          ...
          <p className="text-lg text-gray-600">DevStation과 함께 개발자로서 한 단계 성장하세요</p>
          <Link 
            href="/recruitment" 
            className="inline-flex h-11 px-8 bg-blue-500 text-white font-medium rounded-md hover:bg-blue-600 items-center justify-center"
          >

...
const userPosts = [
  { id: "1", title: "Next.js 14 프로젝트 팀원 모집", status: "모집중", date: "2025-10-10" },
...
const userQuestions = [
  { id: "1", title: "TCP와 UDP의 차이점을 설명하세요", category: "네트워크", score: 10, isApproved: false },
  { id: "2", title: "프로세스와 스레드의 차이는 무엇인가요?", category: "운영체제", score: 5, isApproved: true },
  { id: "3", title: "데이터베이스 정규화에 대해 설명하세요", category: "데이터베이스", score: 10, isApproved: false },
  { id: "4", title: "데이터베이스 정규화에 대해 설명하세요", category: "데이터베이스", score: 10, isApproved: false },
  { id: "5", title: "데이터베이스 정규화에 대해 설명하세요", category: "데이터베이스", score: 10, isApproved: false },
  { id: "6", title: "데이터베이스 정규화에 대해 설명하세요", category: "데이터베이스", score: 10, isApproved: false },
  { id: "7", title: "데이터베이스 정규화에 대해 설명하세요", category: "데이터베이스", score: 10, isApproved: false },
  { id: "8", title: "데이터베이스 정규화에 대해 설명하세요", category: "데이터베이스", score: 10, isApproved: false },
  { id: "9", title: "데이터베이스 정규화에 대해dd 설명하세요", category: "데이터베이스", score: 10, isApproved: false },
];
  ...
  return (
    <div className="max-w-screen-lg mx-auto px-6 py-10">
      <div className="mb-8">
        ...
        <p className="text-gray-500">내가 작성한 글, 댓글, 질문을 확인할 수 있습니다.</p>
      </div>
          ...
          <div>
            <div className="space-y-3">
              {pagedQuestions.map((question) => (
                <div
                  key={question.id}
                  onClick={() => router.replace(`/interview/cs/${question.id}`)}
                  className="flex justify-between items-center p-3 border border-gray-200 rounded-md hover:bg-gray-50 transition cursor-pointer"
                >
                  <div>
